...
@switch($name)
    @case('laravel')
        ...
        {{ $attributes->merge(['class' => '']) }} fill="currentColor" viewBox="0 0 512 512">
    ...
    @case('lumen')
        <svg role="img" viewBox="0 0 24 24" {{ $attributes->merge(['class' => '']) }}
    ...
    @case('php')
        <svg xmlns="http://www.w3.org/2000/svg" {{ $attributes->merge(['class' => '']) }} fill="currentColor" viewBox="0 0 640 512">
            <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
            <path
    ...
    @case('react')
        <svg xmlns="http://www.w3.org/2000/svg" {{ $attributes->merge(['class' => '']) }} fill="currentColor" viewBox="0 0 512 512">
            <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
            <path
    ...
    @case('tailwind')
        <svg role="img" viewBox="0 0 24 24" {{ $attributes->merge(['class' => '']) }} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    @case('vue')
        <svg xmlns="http://www.w3.org/2000/svg" {{ $attributes->merge(['class' => '']) }} viewBox="0 0 448 512"  fill="currentColor">
            <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
            <path
    ...
    @default
        <svg xmlns="http://www.w3.org/2000/svg" {{ $attributes->merge(['class' => '']) }}  fill="currentColor" class="bi bi-code"
            viewBox="0 0 16 16">
            <path
